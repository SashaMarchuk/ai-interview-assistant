...
must_haves:
  truths:
    - "OpenRouter models work with OpenRouter API key"
    - "OpenAI models work with OpenAI API key"
    - "Provider is auto-selected based on model ID"
    - "Both providers stream responses token-by-token"
  artifacts:
